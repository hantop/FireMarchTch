...
+ (UIImage *)placeholderImageWithSize:(CGSize)size {
    ...
    // 占位图的背景色
    UIColor *backgroundColor = [UIColor colorWithRed:((float)((0xF7F7F7 & 0xFF0000) >> 16))/255.0 green:((float)((0xF7F7F7 & 0xFF00) >> 8))/255.0 blue:((float)(0xF7F7F7 & 0xFF))/255.0 alpha:1];
    // 中间LOGO图片
