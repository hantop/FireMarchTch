...
- (id)initWithDelegate:(id<LewPickerControllerDelegate>)delegate{
    ...
    bbtOK.width = 60.f;
    [bbtOK setTintColor:FSYellow];
    
    UIBarButtonItem *bbtCancel = [[UIBarButtonItem alloc] initWithTitle:@"✘" style:UIBarButtonItemStylePlain target:self action:@selector(cancelAction:)];
    bbtCancel.width = 60.f;
    [bbtCancel setTintColor:FSYellow];
...
-(void)showInView:(UIView*)target{
    ...
    UIImageView * ss = [[UIImageView alloc] initWithImage:[image boxblurImageWithBlur:0]];
