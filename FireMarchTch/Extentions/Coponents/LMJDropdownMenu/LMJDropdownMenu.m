...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(dropdownMenu:selectedCellContent:)]) {
        [self.delegate dropdownMenu:self selectedCellContent:[_titleArr objectAtIndex:indexPath.row]]; // 回调代理
    }
